...
## Objects
OBJECTS = src/main.o src/fnd.o src/switch.o src/led.o src/buzzer.o
LINKONLYOBJECTS =
...
## Comment
# 새로운 Object 파일이 필요한 경우(.c 파일이 추가된 경우) ㅒOBJECTS에 다음과 같이 추가한다.
# OBJECTS = main.o new.o
#
# 바이러니 파일 이름은 PROJECT에 지정한다.
